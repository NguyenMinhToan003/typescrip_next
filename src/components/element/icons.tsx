...
export const Icons = {
	...
	settings: (props: IconProps) => (
		...
		>
			...
			<path d='M19.4 15a3.6 3.6 0 0 0 .6-2 3.6 3.6 0 0 0-.6-2' />
			<path d='M4.6 15a3.6 3.6 0 0 0-.6 2 3.6 3.6 0 0 0 .6 2' />
		</svg>
	),
	...
	movies: (props: IconProps) => (
		<svg
			...
			xmlns='http://www.w3.org/2000/svg'
		>
			<path d='M23 18v-6l-7-3 7-3v-6l-17 7v13l17-7z' />
		</svg>
	),
	...
	tv: (props: IconProps) => (
		...
		>
			...
			<polygon points='17 21 12 16 7 21' />
		</svg>
	),
	profile: (props: IconProps) => (
		<svg
			...
			xmlns='http://www.w3.org/2000/svg'
		>
			<path d='M12 14c-3.313 0-6-2.687-6-6s2.687-6 6-6s6 2.687 6 6s-2.687 6-6 6z' />
			<path d='M21 21l-5-5' />
			<path d='M8 21l-5-5' />
		</svg>
	),
	...
	typeLocal: (props: IconProps) => (
		<span className='px-2 py-1 bg-gray-200 text-gray-800 rounded-md'>
			...
			>
				<path d='M12 2c4.4 0 8 3.6 8 8 0 4.8-8 12-8 12s-8-7.2-8-12c0-4.4 3.6-8 8-8z' />
				<circle cx='12' cy='10' r='3' />
			</svg>
			Local
		</span>
	),
	typeGoogle: (props: IconProps) => (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			viewBox='0 0 24 24'
			width='16'
		...
		>
			<path
				fill='#EA4335'
				d='M12 4.75c1.75 0 3.1.7 4.05 1.3l3-3.05C17.2 2 14.75 1 12 1 7.45 1 3.7 3.35 1.95 7l3.75 2.95C6.3 7.95 8.8 4.75 12 4.75z'
			/>
			<path
				fill='#34A853'
				d='M23.25 12c0-.7-.05-1.45-.15-2.15H12v4.05h6.4c-.3 1.5-1.2 2.7-2.45 3.5l3.75 2.95c2.2-2 3.5-4.9 3.5-8.35z'
			/>
			<path
				fill='#FBBC05'
				d='M5.7 14.45c-.25-.85-.45-1.75-.45-2.7s.2-1.85.45-2.7l-3.75-2.95C1.15 8 1 10 1 12s.15 4 .95 5.9l3.75-2.95z'
			/>
			<path
				fill='#4285F4'
				d='M12 23.25c2.75 0 5.2-.9 7.1-2.4l-3.75-2.95c-1.05.7-2.4 1.1-3.85 1.1-2.9 0-5.35-2-6.25-4.75L1.95 17C3.7 20.65 7.45 23.25 12 23.25z'
			/>
		</svg>
	),
}
